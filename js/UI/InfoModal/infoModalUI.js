...
const information = `<div class='modalBox'> 
                      <div class='modalText'>
                        <div>
                          ...
                          <div>
                          The US Geological Survey (USGS) and Esri collaborated to bring the ever-increasing collection of US historical topographic maps to everyone through the USGS Historical Topo Map Explorer. This app brings to life more than 180,000 maps dating from 1882 to 2006. Previously available only as printed lithographic copies, the legacy quadrangles are now available as web viewable images and free, downloadable digital files. The USGS Historical Topographic Map Explorer allows users to explore the historical maps, save the current view as a web map, and download the maps as high-resolution georeferenced images in GeoTIFF format for use in web mapping applications and GIS. Learn more about the app in the <a href="${topMapExplorerItemPage}">item description</a> on ArcGIS Online.
                          </br>
                          </br>
                          ...
                          <div>
                          The USGS scanned each map as is to capture the content and condition of each map sheet. All maps were georeferenced, and metadata was captured as part of the process. Using ArcGIS, the scanned maps comprise the USGS Historical Topographic Maps image service that can be viewed on the web and provides links to allow users to download individual scanned images. Learn more about the image service in the <a href = '${USGSTopoMapCollection}'>item description</a> in ArcGIS Online.
                          </br>
                          </br>
                          <em>
                          ...
                          How to use the Historical Topo Map Explorer:
                            ...
                            <li>
                              Navigate to your location of interest and click on the map view to see which USGS maps are available for in that area.
                            </li>
                            </br>
                            <li>
                              Use the timeline list on the left to explore the names, dates, and thumbnails of the topo maps. Mouse-over the list see geographic extents. Click a topo map to add it to the map.
                            </li>
                            </br>
                            <li>
                          ...
                          <div>
                          The USGS had published <a href ="https://www.usgs.gov/faqs/where-can-i-find-topographic-map-symbol-sheet">these symbol keys</a> to help you identify the symbols used on their topographic maps.
                          </br>
                          </br>
                          <em>
