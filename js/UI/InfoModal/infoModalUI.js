...
const information = `<div class='modalBox'> 
                      <div class='modalText'>
                        <div>
                          ...
                          <div>
                          The US Geological Survey (USGS) and Esri collaborated to bring the ever-increasing collection of US historical topographic maps to everyone through the USGS Historical Topographic Map Explorer. This app brings to life more than 180,000 maps dating from 1882 to 2006. Previously available only as printed lithographic copies, the legacy quadrangles are now available as web viewable images and free, downloadable digital files. The USGS Historical Topographic Map Explorer allows users to explore the historical maps, save the current view as a web map, and download the maps as high-resolution georeferenced images in GeoTIFF format for use in web mapping applications and GIS. Learn more about the app in the <a href="${topMapExplorerItemPage}">item description</a> on ArcGIS Online.
                          </br>
                          </br>
